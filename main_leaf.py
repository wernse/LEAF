...
def main(args):
    ...
    for k,ncla in taskcla:
        ...
        #### LEAF ####
        target_backwards_transfer_task_id = 0
        ...
        if task_id > target_backwards_transfer_task_id:
            ...
            # task_0 = get_gradients(x=task0_train_x, y=task0_train_y, model=model_B, device=device, criterion=criterion, task_id_nominal=backwards_transfer_task_id, mask=consolidated_masks)
...
if __name__ == "__main__":
    ...
    # update name
    name = f"{args.name}_{args.dataset}_SEED_{args.seed}_n_epochs_{args.n_epochs}_pc_valid_{args.pc_valid}_leaf_really_fixed"
    args.name = name
    process_name = f"wsn_wassterin_{args.dataset}"
    setproctitle.setproctitle(process_name)
    os.environ["WANDB_API_KEY"] = "31d8f5a1de78c9c94b0ad9f27c76c0dae4b50102"
